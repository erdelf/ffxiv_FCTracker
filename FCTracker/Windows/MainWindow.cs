...
public class MainWindow : Window, IDisposable
{
    public MainWindow() : base("FC Tracker##FCTrackerMainWindow", ImGuiWindowFlags.NoScrollbar | ImGuiWindowFlags.NoScrollWithMouse)
    {
        ...
        this.fcTable = new Table<FCData>("##FCList",
                                         ...
                                         {
                                             new("Tag", x => Censor.Hide(x.Tag), FilterType: FilterType.String, Alignment: ColumnAlignment.Center),
                                             ...
                                             new("Rank", x => x.Rank.ToString(), FilterType : FilterType.MultiSelect, Alignment: ColumnAlignment.Center, GetTextColor: x => x.Rank > 5 ? EzColor.GreenBright : EzColor.White),
                                             ...
                                             new("Founding Days", x => DateTime.Now.Subtract(x.FoundingDate).Days.ToString(), Alignment: ColumnAlignment.Center, GetTextColor: x => DateTime.Now.Subtract(x.FoundingDate).TotalDays >= 30 ? EzColor.GreenBright : EzColor.White),
                                             new("House", x => Censor.Hide(x.HouseTemp), Alignment: ColumnAlignment.Center),
                                         },
